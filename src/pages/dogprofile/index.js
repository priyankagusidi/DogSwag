    ...
    return (
        ...
        <div className="w-full md:w-10/12 flex flex-col relative">
            <div className="p-4 fixed bg-white w-full border-b border-gray-300 z-10">
               <h3 className="text-lg font-semibold text-[#101010]">Dog Profile</h3>
            </div>
            <div className="mt-16 p-4 max-w-2xl w-full mx-auto">
              <DogProfile showEdit={true} dogdata={props.dogdata} userdata={props.userdata} showImage={true} grid={true} padding={6}/>
            </div>
        </div>
