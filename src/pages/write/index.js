...
// import {m_title,m_description} from '../meta'
...
const index = (props) => {
  ...
  return (
    <div className="bg-gray-100 h-fit">
      ...
      {/*<Tip/>*/}
      <Write userdata={props.userdata} userprofiledata={props.userprofiledata}/>
...
export async function getServerSideProps({req}) {
   try{
    ...
    // const res5 =await fetch(`${url}/api/blogs/blog/${req.query.q}`)
    // const blogdata = await res5.json()

    return {
        props : {userdata,notificationdata}
     }
