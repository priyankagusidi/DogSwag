...
const Slider = dynamic(() => import("@/components/slider/index"), {
  ssr: false,
});
...
const Blog = dynamic(() => import("@/components/allblogs"), {
  ssr: false,
});
...
const index = (props) => {
  ...
  return (
    <div>
      ...
      <Landing  props = { props }/>
      {props.blogdata && props.blogdata.totalblogs ?<Blog  blogdata = { props.blogdata } userdata={props.userdata}/>:<div className="text-center text-2xl my-96 text-gray-500">Share that awesome blog here...</div>}
      <Faq/>
      <Footer/>
    </div>
  )
...
export async function getServerSideProps({req}) {
    ...
    console.log("coindata",coindata,"+++++++++++++++++++++")
     ...
     return {
        props : {userdata,blogdata,notificationdata,coindata}
     }
