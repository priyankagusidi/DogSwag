...
import {about,advertise,monetization,technical,writingblog} from './data2'
        ...
        <div className="mt-8 xl:mt-16 lg:flex lg:-mx-12">
            <div className="lg:mx-12">
                ...
                <div className="mt-4 space-y-4 lg:mt-8">
                    <a onClick={()=>setTab("about")}  className={`block ${TabIndex === "about" ?"text-amber-800":""}  hover:underline`}>About DogSwag</a>
                    <a onClick={()=>setTab("monetization")}  className={`block ${TabIndex === "monetization" ?"text-amber-800":""}  hover:underline`}>Monetization</a>
                    <a onClick={()=>setTab("writingablog")}  className={`block ${TabIndex === "writingablog" ?"text-amber-800":""}  hover:underline`}>Writing a blog</a>
                    <a onClick={()=>setTab("advertise")}  className={`block ${TabIndex === "advertise" ?"text-amber-800":""}  hover:underline`}>Advertise</a>
                    <a onClick={()=>setTab("technical")}  className={`block ${TabIndex === "technical"?"text-amber-800":""}  hover:underline`}>Technical</a>
                </div>
            </div>
            ...
            <div className="flex-1 mt-8 lg:mx-12 lg:mt-0">
                ...
                {
                    FaqCategory && FaqCategory.map((m,i)=>{
                        return (
                                <div className="" key={i}>
