...
function FooterGuided() {
  ...
  const navItems = [
    { text: "Get DO", icon: <img className="md:h-8 sm:h-7 sm:w-7 h-6 w-6 md:w-8 sm:h-7 sm:w-7 h-6 w-6 relative top-1/2 left-1/2 -translate-x-[18px] sm:-translate-y-[0px] translate-y-[10px]" src="/img/calender.svg"/> },
    { text: "Blogs", icon:  <img className="md:h-8 sm:h-7 sm:w-7 h-6 w-6 md:w-8 sm:h-7 sm:w-7 h-6 w-6 relative top-1/2 left-1/2 -translate-x-[18px] sm:-translate-y-[0px] translate-y-[10px]" src="/img/neon.svg"/>},
  ...
  return (
    <div className="bodyNavigationGuided">
      ...
      <ul className="ulGuided">
        ...
        <div className="indicator md:w-[70px] md:h-[70px] sm:h-[65px] sm:w-[65px] h-[55px] w-[55px]"></div>
      </ul>
    </div>
    </div>
