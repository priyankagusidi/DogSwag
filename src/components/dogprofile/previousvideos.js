...
const PreviousVideos = ({ video, setPlayingVideo, index }) => {
    ...
    <div  style={{ background: 'rgba(229, 220, 198, 0.65)'}} className="lg:flex  mb-4 items-center bg-[#434242] p-6 shadow-md rounded-xl cursor-pointer" onClick= {()=>setPlayingVideo(index)}>
      {videoInfo && (
        <div className="lg:flex gap-4 items-center">
          <img className=" h-28  lg:h-24 rounded-lg  object-cover pr-2 " src={`http://img.youtube.com/vi/${video.videoId}/0.jpg`} alt="Video Thumbnail" />
...
<p className="text-sm "> 3 Weeks Ago</p>
             </div>
             <div>
 ...
 text-sm rounded-lg">View Profile</button>
           ...
           <div >
             ...
             <h2 className="text-md font-bold ">Color Carpet Challenge</h2>

<div className="flex mt-2 gap-2 items-center">
<p className="text-sm ">Votes: 2200</p>
