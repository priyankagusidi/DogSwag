    ...
    <div className="container mx-auto px-4 py-2">
      {showSingleVideo ? (
        <div>
          ...
          {/*<Products/>*/}
          <Brands setCurrentVideo={setCurrentVideo} currentVideo={currentVideo}/>
          <Questions setCurrentVideo={setCurrentVideo} currentVideo={currentVideo}/>
        </div>
      ) : (
        <div>
          ...
          <form onSubmit={handleAddVideo} className="mb-4">
            ...
            <button
              type="submit"
              className="ml-2 px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white font-semibold rounded-lg focus:outline-none"
            >
              Add Video
            </button>
          </form>
