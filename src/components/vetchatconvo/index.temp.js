      ...
      
      {
          ...
          <div className="w-full h-full lg:w-8/12  flex justify-center items-center "> 
          {
            !session ? 
                ...
                :
              <ChatInputField  loading={loading} mediaLoading={mediaLoading} setPic={setPic} setSelectedImage={setSelectedImage} selectedImage={selectedImage} sendMessage={sendMessage} senderProfilePic={senderProfilePic} userdata={userdata} messages={messages} handleTextChange={handleTextChange}/>
           }
          </div>  
          :
...

          {
            !session ? 
                ...
                :
              <ChatInputField  observerRef={observerRef} m_loading ={m_loading} chatWindowRef={chatWindowRef}  loading={loading} mediaLoading={mediaLoading} setPic={setPic} setSelectedImage={setSelectedImage} selectedImage={selectedImage} sendMessage={sendMessage} senderProfilePic={senderProfilePic} userdata={userdata} messages={messages} handleTextChange={handleTextChange}/>
           }
           </div>  
