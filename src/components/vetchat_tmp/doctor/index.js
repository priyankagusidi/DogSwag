...
export default function VetChat({userdata,dogdata}){
	...
	return(
		  <div className="h-full relative flex flex-col bg-white font-Inter">
            ...
            <Doctor dogdata={dogdata} handleStartChat={handleStartChat} isChatModalOpen={isChatModalOpen} setIsChatModalOpen={setIsChatModalOpen}  button_title={'start'} isEditing={false} chatType={chatType}/>
		   </div>
          <Modal
           opened={creditModal}
